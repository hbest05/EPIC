...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loginSucceeded((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginWindow::*)(bool )>(_a, &LoginWindow::loginSucceeded, 0))
            return;
    }
}
...
// SIGNAL 0
void LoginWindow::loginSucceeded(bool _t1)
{
